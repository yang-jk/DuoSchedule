...
public final class MainViewModel_Factory implements Factory<MainViewModel> {
  ...
  public static MainViewModel_Factory create(Provider<CourseRepository> repositoryProvider) {
    return new MainViewModel_Factory(repositoryProvider);
  }

  public static MainViewModel newInstance(CourseRepository repository) {
