...
class MyCoursesWidgetReceiver : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        Log.d("MyCoursesWidget", "onReceive: action=${intent.action}")
        ...
        when (intent.action) {
            ...
            AppWidgetManager.ACTION_APPWIDGET_UPDATE -> {
                ...
                val componentName = ComponentName(context, MyCoursesWidgetReceiver::class.java)
    ...
    private fun updateWidget(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                Log.e("MyCoursesWidget", "Failed to update widget", e)
            }
        }
    }

    companion object {
        const val ACTION_UPDATE_WIDGET = "com.duoschedule.action.UPDATE_MY_COURSES_WIDGET"
        ...
        const val WIDGET_REQUEST_CODE = 2001

        fun updateAllWidgets(context: Context) {
            val intent = Intent(context, MyCoursesWidgetReceiver::class.java).apply {
