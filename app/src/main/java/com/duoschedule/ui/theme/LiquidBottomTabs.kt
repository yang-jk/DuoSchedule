...
internal val LocalLiquidBottomTabContentColor = staticCompositionLocalOf { Color.Unspecified }
...
fun LiquidBottomTabs(
    ...
    val accentColor =
        if (isLightTheme) LiquidBottomTabsSpec.SelectedColorLight
        else LiquidBottomTabsSpec.SelectedColorDark
    val containerColor =
    ...
    BoxWithConstraints(
        ...
        CompositionLocalProvider(
            LocalLiquidBottomTabContentColor provides contentColor
        ) {
            Row(
                Modifier
                    .graphicsLayer {
